  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "Mentored junior engineers, led intern bootcamps, and conducted technical interviews to grow team capability.",
        "Built React-based admin dashboards integrated with GraphQL APIs, streamlining change management and deployments.",
      ],
    },
    {
      company: "T-Mobile US",
      ...
      bullets: [
        ...
        "Collaborated with cross-functional teams to deliver microservices and APIs with strong reliability guarantees.",
        "Contributed to DevOps practices with Kubernetes, AWS, and GitLab CI/CD to improve delivery pipelines.",
      ],
    },
    {
      company: "Zuora",
      ...
      bullets: [
        ...
        "Led data migration and large-scale integration projects, ensuring accuracy and seamless transitions for Fortune 500 clients.",
        "Mentored junior consultants in Salesforce and Zuora best practices.",
      ],
    },
    {
      company: "Zuora",
      ...
      bullets: [
        ...
        "Collaborated with clients to run technical workshops, educating them on Zuora’s Salesforce packages and best practices.",
        "Launched open-source, reusable Salesforce/Zuora components to accelerate client implementations",
      ],
    },
    {
    ...
    },
    {
      ...
      bullets: [
        ...
        "Collaborated directly with client stakeholders to translate requirements into technical deliverables.",
        "Maintained build and deployment pipelines, integrating with Jenkins and version control tools.",
      ],
    },
  ],
  education: [
